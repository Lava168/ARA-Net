#!/usr/bin/env python3
"""Evaluate IXI healthy-control specificity inputs."""
...
def main() -> None:
    ...
    parser.add_argument("--output", type=Path, default=Path("outputs/expected_results/ixi_demo_predictions.csv"))
    parser.add_argument("--metrics-json", type=Path, default=Path("outputs/expected_results/ixi_demo_metrics.json"))
