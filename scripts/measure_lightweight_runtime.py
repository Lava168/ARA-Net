...
def main() -> None:
    ...
    parser.add_argument("--output-json", type=Path, default=Path("outputs/expected_results/lightweight_runtime_metrics.json"))
    parser.add_argument("--output-md", type=Path, default=Path("outputs/expected_results/lightweight_runtime_metrics.md"))
